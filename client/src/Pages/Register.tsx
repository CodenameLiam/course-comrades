...
export default function Register() {
	...
	const validateForm = (e: any) => {
		...
		if (state.email.length > 0 && state.password.length > 0 && state.username.length > 0) {
			register(state.email, state.password, state.username, handleSuccess, handleError);
		}
	};
	...
	return (
		<div className="register">
			...
			<div className="right">
				...
				<form className="form" onSubmit={validateForm} autoComplete="off">
					<RegisterTextField
						className="username"
					...
					<RegisterButton className="login-button" type="submit" variant="contained" fullWidth>
						Create Account
					</RegisterButton>
					<div className="form-footer" onClick={navigateToSignIn}>
						<div className="register-text">I already have an account</div>
					</div>
					{/* <Typography
						variant="subtitle2"
